...
const SearchBar = () => {
  ...
  return (
    <>
        {state === "expanded" && <div className='flex items-center justify-between w-full px-4 py-2 bg-transparent border border-border rounded-md hover:bg-accent hover:text-foreground transition-all ease-in-out duration-200 cursor-pointer' onClick={handleDialogOpen}>
        ...
        {state === "collapsed" && (
            <Button variant="ghost" size="icon" className='w-full' onClick={handleDialogOpen}>
                <RiSearch2Fill />
            </Button>
        )}
